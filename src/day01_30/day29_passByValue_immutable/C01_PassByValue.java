package day01_30.day29_passByValue_immutable;
 ...
 */
        int[] arr={5,7,8,10};
        elemanDegistir(arr);
        System.out.println("main method'un içinde diger mthod calıstıktan sonra:"+Arrays.toString(arr));//[5, 6, 8, 7]
    ...
    public static void  elemanDegistir(int[] arr) {
        ...
        System.out.println("method'un icinde"+Arrays.toString(arr));//[5, 6, 8, 7]
