package day01_48.day43_interfaces_iterators;
...
public interface I01_InterfaceBodyOlanMethod {
    ...
    iki tane access modifier kullanma intimali OLAMAZ
    ...
    yeni  eklenen method'u override etmemiz gerekirdi
        ...
        Bu ozellik sayesinde basing default veya static keyword ekleyerek
    ...
    default void teker(){
        System.out.println("tüm arabalarin tekeri vardir.");
    }
    static void direksiyon(){
