...
public class C01_List {
    public static void main(String[] args) {
       List<Integer> sayilar1 = new ArrayList<>();
        ...
        sayilar1.set(2,8); // set verilen indexteki elemanı yeni elemanla değiştirir.
        System.out.println(sayilar1); // [5, 3, 8, 2, 5, 3, 2, 2]

        System.out.println(sayilar1.set(0,12));// bu şekilde set yaparsak sildiğimiz elementide döndürür
